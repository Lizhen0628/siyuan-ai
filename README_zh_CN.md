...
3. 图像理解：根据图片生成文本，或者对图片进行问答。
4. 文档问答：基于文档的问答，支持txt、csv、md等等文件格式。
5. 联网搜索：可以对互联网进行搜索，获取相关内容。
6. 知识库：所有的笔记内容的集合。
<!-- 7. 文生图：根据文本生成图片。 -->
...
20元密钥:20元token额度，有效期一个月

40元密钥:40元token额度，有效期两个月

60元密钥:60元token额度，有效期三个月

以此类推……

**优惠价**：

110元：110元token额度，有效期半年

200元：200元token额度，有效期一年
